...
export default function SearchBarDashboard(props) {
  ...
  const letsLogout = (e) => {
    ...
    if(showMenuModalMobile){
      displayMobileMenuNavigate="flex"
      activeMenucss="activeMenucss"
    }else{
      displayMobileMenuNavigate="none"
      activeMenucss=""
    }
    ...
    return (
        <div className={styles.SearchBarDashboard}>
            ...
            <div className={styles.ModalNavitionMobileAll} style={{display: displayMobileMenuNavigate}} >
                <div className={stylesNavigationDashboard.scrollNavigationHere}>
                    <div className={stylesNavigationDashboard.blockOptions}>
                        ...
                        {permissionsMemo.props.Home &&
                            ...
                            :   
                            <div className={stylesNavigationDashboard.ItemDashboard}>
